...
<div class="row">
            <div class="col-md-7">
                <a href="#"></a>
				<h2><strong>Sri Chaitanya Executive Men's Hostel</strong></h2>
                    <img class="img-responsive" src="H4.jpg" alt="hostel" height="500" width="500">
            ...
            <div class="col-md-5">
                ...
                <h5>
				For Executives & Students</h5>
               <p> Plot No.43 & 44, Shivbag Colony, Opp. Bhaskar Hospital, Ameerpet, Hyderabad.</p>
		...
		<div class="row text-center">
            ...
            <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h1>Map view</h1>
                 <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCq4aSdFrvPRJ8XcoxPdB5vyWAGMg1L66c&callback=initMap"></script><div style='overflow:hidden;height:275px;width:250px;'><div id='gmap_canvas' style='height:275px;width:250px;'></div><div><small><a href="http://embedgooglemaps.com">									embed google maps							</a></small></div><div><small><a href="http://werkenbij.rebelinternet.nl/hr-manager/">HR Manager</a></small></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><script type='text/javascript'>function init_map(){var myOptions = {zoom:10,center:new google.maps.LatLng(17.44073682279995,78.37756331269532),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(17.44073682279995,78.37756331269532)});infowindow = new google.maps.InfoWindow({content:'<strong>Chaitanya Hostel</strong><br>Ameerpet,Hyderabad<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
                        <p>
						   <h1><strong><b>4000/-</b></strong></h1>
                           <a href="" class="btn btn-default btn-lg"> <span class="network-name"><strong>₹ </strong>Book</span></a>
                        </p>
                    </div>
                </div>
            </div>
