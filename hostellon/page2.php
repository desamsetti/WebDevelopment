...
<div class="row">
            <div class="col-md-7">
                <a href="#"></a>
				<h2><strong>Amulya Men's Executive Hostel </strong></h2>
                    <img class="img-responsive" src="H2.jpg" alt="hostel" height="500" width="500">
            ...
            <div class="col-md-5">
                ...
                <p>Plot No.17, Shivbag Colony,Near Satyam Theatre Parking Lot, Ameerpet, Hyderabad.</p>
