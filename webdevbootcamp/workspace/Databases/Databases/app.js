...
mongoose.connect("mongodb+srv://m001-student:ABCabc012@cluster0-05rxc.mongodb.net/test?retryWrites=true",{useNewUrlParser:true});
...
app.post("/superheroes",function(req,res){
    ...
    var newSuperHeroObject = {name:name,title:title,country:country,mainpower:mainpower,image:image};
